...
const initData = {
  pre_heading: "Key0",
  heading: "Discover the first NFT collection on archethic",
  content:
    "Key0 Avatars are the first fully minted collection on Archethic Blockchain, AI generated &amp; inspired by the Cyberpunk movement.\n\nEach Key0 NFT is unique &amp; will grant you access/allocation to the projects launched by the Key Ecosystem.\n\nOwning a Key0 digital collectible will make you a key player in the next era of Archethic&nbsp;Dapps. ",
  btn_1: "Explore",
  btn_2: "Create",
};
