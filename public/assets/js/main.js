...
$(document).ready(function() {
  ...
  (function($) {
    $(".explore-area").each(function(index) {
      ...
      $(this)
        .find(".explore-items")
        .removeClass("explore-items")
        .addClass("explore-items-" + count);
      $(this)
        .find(".explore-item")
        .removeClass("explore-item")
        .addClass("explore-item-" + count);
      $(this)
        .find(".explore-btn")
        .removeClass("explore-btn")
        .addClass("explore-btn-" + count);

      var Shuffle = window.Shuffle;
      var Filter = new Shuffle(
        document.querySelector(".explore-items-" + count),
        {
